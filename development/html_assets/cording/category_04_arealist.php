...
<div class="wrapper">
	<a href="category_04.php"><h2 class="mtitle">子育て支援室</h2></a>
		...
		$.ajax({
			...
			success:function(data){
				...
				if(result.totalpage>1){
						...
						if(page_num!=1){
							$('.copy_pager a').html("&lt;");
							$(".copy_pager *[content_link]").attr("href","category_04_arealist.php"+"?id="+ditrict_id+"&page="+ (parseInt(page_num)-1) );
						...
						if(page_num>2){
							...
							$(".copy_pager *[content_link]").attr("href","category_04_arealist.php"+"?id="+ditrict_id+"&page="+ (parseInt(page_num)-2) );
							$('.pager_area').append($(".copy_pager").html());
						...
						for(i=0;i<view_limit; i++){
							...
							$(".copy_pager *[content_link]").attr("href","category_04_arealist.php"+"?id="+ditrict_id+"&page="+ (parseInt(page_num)+i) );

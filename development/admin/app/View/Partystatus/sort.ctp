<div class="bread"><?php echo $this->Html->link("管理TOP","/"); ?>　＞　コラボ参加ステータス並び替え</div>
<h1>コラボ参加ステータス並び替え</h1>
<div class="main_content">
	<?php
	echo $this->Form->create("Csort",array(
		"inputDefaults"=>array(
			"Div"=>false,
			"label"=>false,
			"legend"=>false,
	...
	<tr class="sec" index="<?php echo $count; ?>">
		...
		<td class="view_name"><?php echo h($r_["Collabostatuslist"]["name"]); ?></td>
		<td>
			<?php echo $this->Form->hidden("Csort.".$count,array("value"=>$r_["Collabostatuslist"]["id"],"class"=>"hidden_id")); ?>
			<?php
			if($count>=2){
			?>

...
<div class="gnavi">
	<ul class="float">
		<li><?php echo $this->Html->link("カテゴリー一覧",array("controller"=>"category","action"=>"index")); ?></li>
		<li class="active"><?php echo $this->Html->link("地区一覧",array("controller"=>"district","action"=>"index")); ?></li>
	</ul>
</div>
<?php
if(isset($alert))
...
<div class="right mb10">
	<?php echo $this->Html->link("地区新規登録",array("controller"=>"district","action"=>"edit"),array("class"=>"buttons")); ?>
</div>

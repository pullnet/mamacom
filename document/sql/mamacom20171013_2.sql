...
CREATE TABLE `categories` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COMMENT='カテゴリー情報';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `contents` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COMMENT='コンテンツ情報';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `contents` VALUES (1,NULL,NULL,NULL,NULL,'2001','テストタイトル1',1,1,8,'説明テキストJSOM','店舗情報JSOM',NULL,NULL),(2,NULL,NULL,NULL,NULL,'2001','テストタイトル2',1,2,9,'説明テキストJSOM','店舗情報JSOM',NULL,NULL),(3,NULL,NULL,NULL,NULL,'2001','テストタイトル',1,1,8,'説明テキストJSOM','店舗情報JSOM',NULL,NULL),(4,NULL,NULL,NULL,NULL,'2001','テストタイトル',1,1,8,'説明テキストJSOM','店舗情報JSOM',NULL,NULL),(7,'2017-10-13 18:01:00','2017-10-13 18:01:00',1,1,'210','テスト',0,1,8,'{\"ttl1\":\"test\",\"ttl2\":\"test\",\"text1\":\"testtest\",\"text2\":\"testtesttest\"}','{\"postnumber\":\"テスト\",\"address\":\"0900000\",\"tel\":null,\"shop_text\":\"受付時間など\"}',NULL,NULL),(8,'2017-10-13 18:02:08','2017-10-13 18:42:58',1,1,'210','テスト',0,1,8,'{\"ttl1\":\"test\",\"ttl2\":\"test\",\"text1\":\"testtest\",\"text2\":\"testtesttest\"}','{\"postnumber\":\"014\",\"address\":\"テスト\",\"tel\":\"0900000\",\"shop_text\":\"受付時間など\"}',NULL,NULL);
...
CREATE TABLE `freepagecategories` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='フリーページカテゴリー情報';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-10-13 20:44:58

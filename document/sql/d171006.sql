...
CREATE TABLE `admins` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='管理アカウント情報';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `admins` VALUES (1,NULL,NULL,NULL,NULL,'admin1','741770f452821c5d37032a904b84660ab48c950f','初期アカウント','1234');
...
-- Dump completed on 2017-10-06 10:20:03
